...
ENC_KEY = input("Welcome Alice, Please enter the pre-shared key: ")

#input("Enter the secret shared key:")
...
def main():
    ...
    while True:
        ...
        new_msg = vigenere_enc(message)
        print("Encrypted and sent as: " + new_msg)
        sendTextViaSocket(new_msg, sock)
...
def receiveTextViaSocket(sock):
    """
    Method that will send a message via the socket
